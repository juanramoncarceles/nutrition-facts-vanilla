...
function filterFood(keyword) {
  ...
  for (var _i = 0; _i < foodListItems.children.length; _i++) {
    if (!foodListItems.children[_i].dataset.name.toLowerCase().includes(string)) {
      foodListItems.children[_i].style.display = 'none';
    } else {
      foodListItems.children[_i].style.display = 'unset';
    }
  }
}
...
},{}]},{},["../../../../../../home/juanramon/.npm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/script.js"], null)
